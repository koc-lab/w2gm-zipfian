...
class Word2GM(object):
    ...
    ### Bu fonksiyonu ben yazdım !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    def dotofavg(self, idx1, idx2, verbose=False):
        avg1 = (self.mus_n_multi[idx1, 0] + self.mus_n_multi[idx1, 1])/2
        avg2 = (self.mus_n_multi[idx2, 0] + self.mus_n_multi[idx2, 1])/2
        return np.dot(avg1, avg2)
